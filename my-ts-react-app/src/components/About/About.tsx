    ...
    return (
        <>
            <div className="main-text">
                    <h1>Mi Vida 🌏</h1>
                    <h2>Who am I?</h2>
                    <p>Well I'm so glad you asked! I was born in the Dominican Republic 🏝️, and moved to the states when I was 7 years old. Since I was a child, I've loved adventures and physical activity of any kind. In my day to day life I enjoy hiking, singing and songwriting, playing videogames, and spending time with my loved ones.</p>
                    <h2>My Goals</h2>
