    ...
    return (
        <>
            <div className="main-text">
                    <h1>Mi Vida 🌏</h1>
                    <h2>Who am I?</h2>
                    <p>I was born in the Dominican Republic 🏝️, raised speaking english and spanish,
                    ...
                    other languages and technologies. I am currently in the process of learning TypeScript!</p>
                    <h2>My Goals</h2>
